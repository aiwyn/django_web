...
class Author(models.Model):
    ...
    cellphone = models.CharField(max_length=50, verbose_name=FoundationConst.VN_CELLPHONE)
    gender = models.IntegerField(choices=FoundationConst.GENDER_CHOICES, verbose_name=FoundationConst.VN_GENDER, default=FoundationConst.GENDER_PRIVATE)
    school = models.CharField(max_length=100, verbose_name=FoundationConst.VN_SCHOOL)
    city = models.CharField(max_length=100, verbose_name=FoundationConst.VN_CITY, default="")
    status = models.IntegerField(choices=FoundationConst.STATUS_CHOICES, verbose_name=FoundationConst.VN_STATUS, default=FoundationConst.STATUS_ONLINE)
...
class Work(models.Model):
    name = models.CharField(max_length=100, verbose_name=FoundationConst.VN_NAME)
    image = models.ImageField(upload_to="", verbose_name=FoundationConst.VN_IMAGE)
    # image = models.ImageField(upload_to=handle_image_upload(WorkConfig.REL_PATH_IMAGE), verbose_name=FoundationConst.VN_IMAGE)
    ...
    sharedCount = models.IntegerField(default=0, verbose_name=FoundationConst.VN_SHARED_COUNT)
