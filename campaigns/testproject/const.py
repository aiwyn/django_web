...
class Momangers(object):
    RN_USR_NAME = u'用户昵称'
    RN_USR_NUM = u'用户手机'
    RN_USR_ADDR = u'用户地址'
    RN_USR_DISPLAY = u'用户头像'
    RN_USR_PASSWD = u'密码'
    RN_USR_SEX = u'性别'
    RN_USR_POINT = u'积分'
    RN_USR_PRID = u'奖品id'
    RN_USR_DATE = u'签到时间'
    RN_USR_CONTINUE = u'连续签到'
    RN_USR_OPENID = u'openid'

class management(object):
    VN_USR_NAME = 'nickname'
    VN_USR_NUM = 'usernum'
    VN_USR_ADDR = 'usraddr'
    VN_USR_DISPLAY = 'display'
    VN_USR_PASSWD = 'passwd'
    VN_USR_SEX = 'sex'
    VN_USR_POINT = 'point'
    VN_USR_ID = 'id'
    VN_USR_CONTINUE = 'continuity'


class UsrPoint(object):
    VN_TABLE_NAME = u'签到记录'
