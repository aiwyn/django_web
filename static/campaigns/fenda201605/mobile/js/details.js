$(function(){
	...
	var workId=getQueryString("worId");
	var data_Url='';
	$.ajax({
				type : 'POST',
				async : false,
			...
			$(".details").click(function(){
				$.ajax({
					...
					dataType : "json",
					success : function(data) {
							$('.pro_name1 span').html( parseInt( $('.pro_name1 span').text())+1 );
					},
					error:function(){
						Diolag();
						return false;
	...
	$('.shake').click(function(){
		$('.dialog_wrap1').removeClass("none")
		Tiem=setTimeout(function(){
			$('.dialog_wrap1').addClass("none");
		},4000)
	})	
	$('.dialog_wrap1').click(function(){
		$('.dialog_wrap1').addClass("none");
		clearTimeout(Tiem);
	})
