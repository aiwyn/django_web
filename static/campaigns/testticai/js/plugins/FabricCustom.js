/* build: `node build.js modules=gestures,interaction minifier=uglifyjs` */
/*! Fabric.js Copyright 2008-2015, Printio (Juriy Zaytsev, Maxim Chernyak) */
// 改：为了绘四个控制角
function FabricCustom(){
    this.controlImage = null;
    this.controlSize = null;
    this.isLoaded = false;
}
FabricCustom.prototype = {
    loadControlImageObj: function(imageObj) {
        this.controlImage = imageObj;
        this.isLoaded = true;
        this.controlSize = this.controlImage.width / 2;
    },
    drawControl: function(control, ctx, left, top, size) {
        if (!this.isLoaded) alert('Need control image!');
        var startTop = null, startLeft = null;
        if (control === "tl") {
            startTop = startLeft = 0;
        } else if (control === "tr") {
            startTop = 0;
            startLeft = this.controlSize;
        } else if (control === "mtr") {
            startTop = startLeft = this.controlSize;
        } else if (control === "bl") {
            startTop = this.controlSize;
            startLeft = 0;
        }
        if (startTop != null)
            ctx.drawImage(this.controlImage,
                startLeft, startTop, this.controlSize, this.controlSize,
                left, top, size, size
            );
    }
};
var fabricCustom = new FabricCustom();
//
    ...
    fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        setCoords: function() {
            ...
            // offset added for rotate and scale actions
                ...
                // 改：修改旋转点位置
                mtr = f(new fabric.Point(_tr.x - (wh.y * sinTh),   _tr.y + (wh.y * cosTh)));
...
(function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        _drawControl: function(control, ctx, methodName, left, top) {
            ...
            // 改：将四个角绘上图形
            fabricCustom.drawControl(control, ctx, left, top, size);
            //ctx[methodName](left, top, size, size);
        },
        _drawControlImage: function() {
