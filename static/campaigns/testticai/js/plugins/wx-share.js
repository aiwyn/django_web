var WX_share=function(){
			...
			var Url="http://fanta.kuh5.net/testticai/index";
			var  TT='体彩测试标题';
			var ImgUrl='http://fanta.kuh5.net/static/campaigns/testticai/mobile/image/shakeimg.png';
			var Desc='体彩测试文案';
			$.ajax({
				type: "POST",
				url: "http://fanta.kuh5.net/testticai/get_sign_package",
				data: {
					url:IndexUrl
				},
				async: !0,
...
var shareUpdate = function () {
	...
	$.ajax({
				type: "POST",
				url: "http://fanta.kuh5.net/picc/mobile/mobile_share",
				data: {
					url:IndexUrl
				},
				async: !0,
